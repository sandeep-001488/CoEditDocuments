...
// // Store active users per document
// const activeUsers = new Map();
// // Store document owners currently online
// const activeOwners = new Map();
// // Track join notifications sent
...
//         // If owner, mark as online FIRST before checking
//         if (isOwner) {
...
//         // If not owner, check if owner is online (with small grace period)
//         if (!isOwner) {
...
//         // Remove old socket of same user if exists (prevents duplicates)
...
//         // If owner disconnected, kick all users
//         if (wasOwner) {
//           logger.warn(
//             `⚠️ Owner disconnected from document ${documentId}, kicking all users`
//           );

//           // Small delay to ensure owner disconnect is processed
//           setTimeout(() => {
...
//             // Clean up all data for this document
//             activeUsers.delete(documentId);
...
//   // If owner is leaving, remove from active owners
...
//   // Send user left notification only on disconnect
...
//     // Remove from join notifications
//     if (joinNotificationsSent.has(documentId)) {
...
// // Helper function to get unique users (no duplicates)
