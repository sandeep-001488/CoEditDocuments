...
//   else doc.collaborators.push({ user: collaborator._id, role });
...
// export const generateShareLink = async (documentId, userId) => {
//   const doc = await Document.findById(documentId);
//   if (!doc) throw new Error("Document not found");
//   if (doc.owner.toString() !== userId) throw new Error("Not authorized");
...
//   return {
//     shareLink: `${process.env.CLIENT_URL}/editor/${documentId}?token=${token}`,
//   };
// };
import Document from "../models/Document.js";
import User from "../models/User.js";
